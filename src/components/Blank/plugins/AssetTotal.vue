<template>
    <li
        ...
        class="relative py-2 pr-12 grid grid-cols-10 items-center gap-2 border-t-2 border-b-silver-900 font-bold text-center"
    >
...
const sell = () => emit('sell', (quantity.value * Number(sellPrice.value)));
</script>
